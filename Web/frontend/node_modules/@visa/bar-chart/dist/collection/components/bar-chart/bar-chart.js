...
const { prepareStrokeColorsFromScheme, calculateLuminance, verifyTextHasSpace, checkAttributeTransitions, createTextStrokeFilter, drawHoverStrokes, removeHoverStrokes, buildStrokes, convertColorsToTextures, initializeElementAccess, initializeDescriptionRoot, setElementFocusHandler, setElementAccessID, setAccessibilityController, hideNonessentialGroups, setAccessTitle, setAccessSubtitle, setAccessLongDescription, setAccessExecutiveSummary, setAccessPurpose, setAccessContext, setAccessStatistics, setAccessChartCounts, setAccessXAxis, setAccessYAxis, setAccessStructure, setAccessAnnotation, retainAccessFocus, checkAccessFocus, setElementInteractionAccessState, setAccessibilityDescriptionWidth, autoTextColor, annotate, chartAccessors, checkInteraction, checkClicked, checkHovered, convertVisaColor, drawAxis, drawGrid, drawLegend, setLegendInteractionState, drawTooltip, formatDataLabel, getColors, getLicenses, getPadding, getScopedData, initTooltipStyle, placeDataLabels, overrideTitleTooltip, transitionEndAll, scopeDataKeys, visaColors, validateAccessibilityProps, findTagLevel } = Utils;
export class BarChart {
    constructor() {
        ...
        this.shouldUpdateClickFunc = false;
        this.shouldUpdateHoverFunc = false;
        this.shouldUpdateMouseoutFunc = false;
        ...
        this.textTreatmentHandler = (d, i, n) => {
            ...
            const color = this.placement === 'bottom' || this.placement === 'left' ? autoTextColor(bgColor) : visaColors.dark_text;
            const me = select(n[i]);
    ...
    setColors() {
        ...
        this.preparedColors = this.groupAccessor
            ? getColors(colorFromProps, scaleOrdinal()
    ...
    drawXGrid() {
        drawGrid(this.gridG, this.innerPaddedHeight, this.innerPaddedWidth, this.x, false, !(!(this.layout === 'vertical') && this.xAxis.gridVisible), this.xAxis.tickInterval);
    }
    drawYGrid() {
        drawGrid(this.gridG, this.innerPaddedHeight, this.innerPaddedWidth, this.y, true, !(this.layout === 'vertical' && this.yAxis.gridVisible), this.yAxis.tickInterval);
    }
    enterGeometries() {
    ...
    processLabelOpacity(selection) {
        ...
        selection.attr('opacity', d => {
            ...
            const hasRoom = this.accessibility.showSmallLabels ||
                verifyTextHasSpace({
    ...
    render() {
        ...
        return (h("div", { class: `o-layout is--${this.layout} ${theme}` },
            h("div", { class: "o-layout--chart" },
                h(this.topLevel, { class: "bar-main-title vcl-main-title" }, this.mainTitle),
                h(this.bottomLevel, { class: "visa-ui-text--instructions bar-sub-title vcl-sub-title" }, this.subTitle),
                h("div", { class: "bar-legend vcl-legend", style: { display: this.legend.visible && this.groupAccessor ? 'block' : 'none' } }),
                h("div", { class: "visa-viz-d3-bar-container" }),
                h("div", { class: "bar-tooltip vcl-tooltip", style: { display: this.showTooltip ? 'block' : 'none' } }),
    ...
    static get properties() { return {
        "mainTitle": {
            ...
            "reflect": false,
            "defaultValue": "BarChartDefaultValues.mainTitle"
        },
        "subTitle": {
            "type": "string",
            "mutable": true,
            ...
            "attribute": "sub-title",
            "reflect": false,
            "defaultValue": "BarChartDefaultValues.subTitle"
        },
        "height": {
            "type": "number",
            "mutable": true,
            ...
            "attribute": "height",
            "reflect": false,
            "defaultValue": "BarChartDefaultValues.height"
        },
        "width": {
            "type": "number",
            "mutable": true,
            ...
            "attribute": "width",
            "reflect": false,
            "defaultValue": "BarChartDefaultValues.width"
        },
        "layout": {
            "type": "string",
            "mutable": true,
            ...
            "attribute": "layout",
            "reflect": false,
            "defaultValue": "BarChartDefaultValues.layout"
        },
        "highestHeadingLevel": {
            "type": "any",
            "mutable": true,
            ...
            "reflect": false,
            "defaultValue": "BarChartDefaultValues.highestHeadingLevel"
        },
        "margin": {
            "type": "unknown",
            "mutable": true,
            ...
            "defaultValue": "BarChartDefaultValues.margin"
        },
        "padding": {
            "type": "unknown",
            "mutable": true,
            ...
            "defaultValue": "BarChartDefaultValues.padding"
        },
        "data": {
            "type": "unknown",
            "mutable": false,
        ...
        "ordinalAccessor": {
            ...
            "reflect": false,
            "defaultValue": "BarChartDefaultValues.ordinalAccessor"
        },
        "valueAccessor": {
            "type": "string",
            "mutable": true,
            ...
            "reflect": false,
            "defaultValue": "BarChartDefaultValues.valueAccessor"
        },
        "groupAccessor": {
            "type": "string",
            "mutable": true,
            ...
            "reflect": false,
            "defaultValue": "BarChartDefaultValues.groupAccessor"
        },
        "sortOrder": {
            "type": "string",
            "mutable": true,
            ...
            "reflect": false,
            "defaultValue": "BarChartDefaultValues.sortOrder"
        },
        "xAxis": {
            "type": "unknown",
            "mutable": true,
            ...
            "defaultValue": "BarChartDefaultValues.xAxis"
        },
        "yAxis": {
            "type": "unknown",
            "mutable": true,
            ...
            "defaultValue": "BarChartDefaultValues.yAxis"
        },
        "wrapLabel": {
            "type": "boolean",
            "mutable": true,
            ...
            "reflect": false,
            "defaultValue": "BarChartDefaultValues.wrapLabel"
        },
        "colorPalette": {
            "type": "string",
            "mutable": true,
            ...
            "reflect": false,
            "defaultValue": "BarChartDefaultValues.colorPalette"
        },
        "colors": {
            "type": "unknown",
            "mutable": true,
        ...
        "hoverStyle": {
            ...
            "defaultValue": "BarChartDefaultValues.hoverStyle"
        },
        "clickStyle": {
            "type": "unknown",
            "mutable": true,
            ...
            "defaultValue": "BarChartDefaultValues.clickStyle"
        },
        "referenceStyle": {
            "type": "unknown",
            "mutable": true,
            ...
            "defaultValue": "BarChartDefaultValues.referenceStyle"
        },
        "cursor": {
            "type": "string",
            "mutable": true,
            ...
            "attribute": "cursor",
            "reflect": false,
            "defaultValue": "BarChartDefaultValues.cursor"
        },
        "roundedCorner": {
            "type": "number",
            "mutable": true,
            ...
            "reflect": false,
            "defaultValue": "BarChartDefaultValues.roundedCorner"
        },
        "barIntervalRatio": {
            "type": "number",
            "mutable": true,
            ...
            "reflect": false,
            "defaultValue": "BarChartDefaultValues.barIntervalRatio"
        },
        "hoverOpacity": {
            "type": "number",
            "mutable": true,
            ...
            "reflect": false,
            "defaultValue": "BarChartDefaultValues.hoverOpacity"
        },
        "dataLabel": {
            "type": "unknown",
            "mutable": true,
            ...
            "defaultValue": "BarChartDefaultValues.dataLabel"
        },
        "showTooltip": {
            "type": "boolean",
            "mutable": true,
            ...
            "reflect": false,
            "defaultValue": "BarChartDefaultValues.showTooltip"
        },
        "tooltipLabel": {
            "type": "unknown",
            "mutable": true,
            ...
            "defaultValue": "BarChartDefaultValues.tooltipLabel"
        },
        "accessibility": {
            "type": "unknown",
            "mutable": true,
            ...
            "defaultValue": "BarChartDefaultValues.accessibility"
        },
        "legend": {
            "type": "unknown",
            "mutable": true,
            ...
            "defaultValue": "BarChartDefaultValues.legend"
        },
        "annotations": {
            "type": "unknown",
            "mutable": true,
            ...
            "defaultValue": "BarChartDefaultValues.annotations"
        },
        "maxValueOverride": {
            "type": "number",
            "mutable": false,
        ...
        "referenceLines": {
            ...
            "defaultValue": "BarChartDefaultValues.referenceLines"
        },
        "suppressEvents": {
            "type": "boolean",
            "mutable": false,
            ...
            "reflect": false,
            "defaultValue": "BarChartDefaultValues.suppressEvents"
        },
        "hoverHighlight": {
            "type": "unknown",
            "mutable": true,
        ...
        "clickHighlight": {
            ...
            "defaultValue": "BarChartDefaultValues.clickHighlight"
        },
        "interactionKeys": {
            "type": "unknown",
            "mutable": true,
    ...
    static get elementRef() { return "barChartEl"; }
