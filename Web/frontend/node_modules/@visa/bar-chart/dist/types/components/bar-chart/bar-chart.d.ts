...
import { IBoxModelType, IHoverStyleType, IClickStyleType, IAxisType, IReferenceStyleType, IDataLabelType, ITooltipLabelType, IAccessibilityType, ILegendType } from '@visa/charts-types';
import 'd3-transition';
export declare class BarChart {
    clickFunc: EventEmitter;
    hoverFunc: EventEmitter;
    mouseOutFunc: EventEmitter;
    mainTitle: string;
    subTitle: string;
    height: number;
    width: number;
    ...
    shouldUpdateClickFunc: boolean;
    shouldUpdateHoverFunc: boolean;
    shouldUpdateMouseoutFunc: boolean;
    ...
    cornerWatcher(_newVal: any, _oldVal: any): void;
    intervalRatioWatcher(_newVal: any, _oldVal: any): void;
    ...
    componentDidUpdate(): Promise<unknown>;
    ...
    setRoundedCorners(): void;
    validateClickStyle(): void;
    validateHoverStyle(): void;
    updateInteractionState(): void;
    setLabelOpacity(): void;
    processLabelOpacity(selection: any): void;
    checkLabelColorAgainstBackground(): void;
    ...
    onClickHandler(d: any): void;
    onHoverHandler(d: any, isLegend?: any): void;
