...
const NAMESPACE = 'visa-charts-data-table';
...
const patchEsm = () => {
    ...
    if ( !(CSS && CSS.supports && CSS.supports('color', 'var(--c)'))) {
        // @ts-ignore
        return new Promise(function (resolve) { resolve(require(/* webpackChunkName: "stencil-polyfills-css-shim" */ './css-shim-c6090d74.js')); }).then(() => {
...
const patchBrowser = () => {
    ...
    }
    {
        ...
        if ( !win.customElements) {
            ...
            // @ts-ignore
            return new Promise(function (resolve) { resolve(require(/* webpackChunkName: "stencil-polyfills-dom" */ './dom-512bcfe6.js')); }).then(() => opts);
        }
    }
