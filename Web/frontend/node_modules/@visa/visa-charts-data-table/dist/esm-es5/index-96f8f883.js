...
var NAMESPACE = 'visa-charts-data-table';
var isSvgMode = false;
...
var patchEsm = function () {
    ...
    if (!(CSS && CSS.supports && CSS.supports('color', 'var(--c)'))) {
        // @ts-ignore
        return import(/* webpackChunkName: "stencil-polyfills-css-shim" */ './css-shim-e3b85c14.js').then(function () {
...
var patchBrowser = function () {
    ...
    }
    {
        ...
        if (!win.customElements) {
            ...
            // @ts-ignore
            return import(/* webpackChunkName: "stencil-polyfills-dom" */ './dom-aa2cca86.js').then(function () { return opts; });
        }
    }
